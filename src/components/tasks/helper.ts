...
export const MOCK_TASKS: Task[] = [
    ...
    assignees: [
      {
        ...
        name: "Daniel Clark",
        avatar:
          "https://images.unsplash.com/photo-1556742087-4e3f8b5ba301?crop=entropy&cs=tinysrgb&fit=max&ixid=MnwzNjUyOXwwfDF8c2VhY2h8OXx8cGFuZWwgbGVndXJlcyxlbnwwfHx8fDE2NTI3NzI5Mjk&ixlib=rb-1.2.1&q=80&w=256",
      },
    ],
    dueDate: "Oct 10, 2024",
    priority: "low",
  ...
  },
  {
    ...
    summary: "Revise and update the terms of service document",
    status: "done",
    labels: ["legal"],
    assignees: [
      {
        ...
        name: "Rachel Adams",
        avatar:
          "https://images.unsplash.com/photo-1561932827-0abcf29cbe5b?crop=entropy&cs=tinysrgb&fit=max&ixid=MnwzNjUyOXwwfDF8c2VhY2h8MXx8Y2hlY2t8ZW58fHx8fDE2NTI3NzI5Mjk&ixlib=rb-1.2.1&q=80&w=256",
      },
    ],
    dueDate: "Oct 15, 2024",
    priority: "medium",
